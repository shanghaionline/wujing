...
ScrollPic.prototype.initialize = function() {
    ...
    this.scrollContDiv = online.$(this.scrollContId);
    ...
    online.addEvent(this.scrollContDiv, "mouseover",
    function() {
        a.stop()
    });
    online.addEvent(this.scrollContDiv, "mouseout",
    function() {
        a.play()
    });
    if (this.arrLeftId) {
        this.arrLeftObj = online.$(this.arrLeftId);
        if (this.arrLeftObj) {
            online.addEvent(this.arrLeftObj, "mousedown",
            function() {
                a.rightMouseDown()
            });
            online.addEvent(this.arrLeftObj, "mouseup",
            function() {
                a.rightEnd()
            });
            online.addEvent(this.arrLeftObj, "mouseout",
            function() {
                a.rightEnd()
            })
        }
    ...
    if (this.arrRightId) {
        this.arrRightObj = online.$(this.arrRightId);
        if (this.arrRightObj) {
            online.addEvent(this.arrRightObj, "mousedown",
            function() {
                a.leftMouseDown()
            });
            online.addEvent(this.arrRightObj, "mouseup",
            function() {
                a.leftEnd()
            });
            online.addEvent(this.arrRightObj, "mouseout",
            function() {
                a.leftEnd()
            })
        }
    ...
    if (this.dotListId) {
        this.dotListObj = online.$(this.dotListId);
